...
global esttab_options b(3)   se(3)
...
gen er4b_share = nl_hawaiian / nl_total
...
global ER_SHARES er1_share er2_share er3_share er4_share er4b_share er5_share er6_share er7_share
...
dtable repaired ethno_racial_frac $ER_SHARES $infrastructure $demo_controls $econ_controls, ///
		continuous(repaired ethno_racial_frac $ER_SHARES $infrastructure $demo_controls $econ_controls, statistics( mean sd min p25 p50 p75 max)) nosample 
